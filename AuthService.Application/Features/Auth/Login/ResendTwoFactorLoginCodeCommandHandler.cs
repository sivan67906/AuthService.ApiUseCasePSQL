...
public sealed class ResendTwoFactorLoginCodeCommandHandler : IRequestHandler<ResendTwoFactorLoginCodeCommand, Unit>
{
    ...
    public async Task<Unit> Handle(ResendTwoFactorLoginCodeCommand request, CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("Two-factor code resent to {Email}", user.Email);
