...
public sealed class GetUsersWithoutRolesQueryHandler
    : IRequestHandler<GetUsersWithoutRolesQuery, List<UserWithoutRoleDto>>
{
    private readonly UserManager<ApplicationUser> _userManager;
    private readonly IAppDbContext _db;

    public GetUsersWithoutRolesQueryHandler(
    ...
    public async Task<List<UserWithoutRoleDto>> Handle(
        GetUsersWithoutRolesQuery request,
        CancellationToken cancellationToken)
    {
        // Get all user IDs that have role mappings
